...
class Customers extends Section implements Initializable
{
    ...
    public function onDisplay($payload = [])
    {
        $columns = [
            ...
            AdminColumn::text('user_name', 'Имя пользователя')->setWidth('50px')->setHtmlAttribute('class', 'text-center'),
            AdminColumn::text('count_of_clicks', 'Количество кликов')->setWidth('50px')->setHtmlAttribute('class', 'text-center'),
